...
public class Lettuce implements Serializable {

    private String barcode, manufacturer, brandName;
    String price;
    String type = "FOOD";
    private Meat nextFoodType;

    private Lettuce(){}

    private Lettuce(Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public Builder copy(Lettuce value)
        {
